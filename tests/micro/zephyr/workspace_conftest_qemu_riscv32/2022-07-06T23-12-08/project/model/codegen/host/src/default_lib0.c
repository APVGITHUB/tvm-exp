...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_multiply_add(TVMValue* args, int* type_code, int num_args, TVMValue* out_value, int* out_type_code, void* resource_handle);
#ifdef __cplusplus
extern "C"
#endif
...
static TVMBackendPackedCFunc _tvm_func_array[] = {
    (TVMBackendPackedCFunc)tvmgen_default_fused_multiply_add,
...
static const TVMFuncRegistry _tvm_func_registry = {
    "\003\000tvmgen_default_fused_multiply_add\000tvmgen_default___tvm_main__\000tvmgen_default_get_c_metadata\000",    _tvm_func_array,
};
